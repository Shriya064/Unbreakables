...
var cards=new Array(), nCards, cover, openContent, openContentText, pageIsOpen = false,
...
function onCardClick(card, i) {
 ...
 document.getElementById('circularMenu1').style.display = 'none';
...
function animateCoverUp(card) {
  ...
  openContentText.innerHTML = '<div style="color:#a21a1a;text-align = center;font-size:40px;font-family:Bahnschrift">'+card.children[2].textContent+'</div>'+'<br>'+'<div id="par">'+card.children[3].textContent+'</div>';
...
function onCloseClick() {
  ...
  document.getElementById('circularMenu1').style.display = 'block';
  document.getElementById('head').style.display = 'block';
  document.getElementById('logo').style.display = 'block';

   for(var j=0;j<cards.length;j++)
   {
    if(cards[j] != currentCard)
     {
